...
public class RegisterAcitivy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseApp.initializeApp(RegisterAcitivy.this);
        ...
        fAuth.createUserWithEmailAndPassword(email,passwordUser).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (!task.isSuccessful()){
                    ...
                    Toast.makeText(RegisterAcitivy.this,"Proses Pendaftaran gagal"+task.getException().toString(),Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(RegisterAcitivy.this,"Register Succes ! Please go to Login page \n" +
