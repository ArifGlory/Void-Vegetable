...
public class LoginPSayur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_psayur);

        Firebase.setAndroidContext(this);
        FirebaseApp.initializeApp(LoginPSayur.this);
        ...
        daftarPenjual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i = new Intent(getApplicationContext(),RegisterPSayurActivity.class);
                startActivity(i);
            }
        });
    ...
    private void doLogin(final String email,String passwordUser){
        fAuth.signInWithEmailAndPassword(email,passwordUser).addOnCompleteListener(LoginPSayur.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (!task.isSuccessful()){
                    ...
                    mUserPref.setBagian("psayur");
                    i = new Intent(LoginPSayur.this,SplashActivity.class);
                    startActivity(i);
